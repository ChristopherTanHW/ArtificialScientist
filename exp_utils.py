...
def get_parser():
    ...
    parser.add_argument('--difficulty', default='character_level', help='difficulty level')
    parser.add_argument('--num_eps', default=100, help='number of episodes')

    parser.add_argument('--env', type=str, default='rtfm:rock_paper_scissors-v0',
                        help='Gym environment.')
    parser.add_argument('--mode', default='train',
                        choices=['train', 'test', 'test_render', 'train_writer', 'collect_rollouts'],
